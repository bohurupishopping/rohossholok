...
class AppTheme {
  ...
  static ThemeData get darkTheme {
    const ColorScheme colorScheme = ColorScheme.dark(
      ...
      // Secondary colors
      secondary: Color(0xFFFFB74D), // Light orange for dark theme
      onSecondary: Color(0xFFE65100), // Dark orange
      secondaryContainer: Color(0xFFFF8F00), // Medium orange
      onSecondaryContainer: Color(0xFFFFF3E0), // Very light orange
      ...
      // Outline and shadow
      outline: Color(0xFF424242), // Medium dark for borders
      shadow: Color(0xFF000000), // Black
      
      // Inverse colors
      inverseSurface: Color(0xFFE0E0E0), // Light grey
      onInverseSurface: Color(0xFF121212), // Dark
      inversePrimary: Color(0xFF1565C0), // Primary blue
    );
    ...
    return ThemeData(
      ...
      // ... (other theme configurations would be similar to light theme)
    );
  }
